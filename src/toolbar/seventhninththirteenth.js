...
function addSeventhNinthThirteenthButtons(toolbar){
  ...
  addSeventhButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 11, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  addSeventhButton.addEventListener("click", function(event) {

    if(addSeventh){
      addSeventhButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 11, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    } else {
      addSeventhButton.graphics.beginFill("Pink").drawRoundRectComplex(KEYSIZE * 11, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    }
  ...
  addSeventhText.y = KEYSIZE * 1.3
  toolbar.addChild(addSeventhText)

  // Add ninth
  var addNinthButton = new createjs.Shape();
  addNinthButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 12, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  addNinthButton.addEventListener("click", function(event) {
    if(addNinth){
      addNinthButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 12, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    } else {
      addNinthButton.graphics.beginFill("Pink").drawRoundRectComplex(KEYSIZE * 12, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    }
    addNinth = !addNinth;
  });
  ...
  addNinthText.y = KEYSIZE * 1.3
  toolbar.addChild(addNinthText)

  // Add 13th
  var addThirteenthButton = new createjs.Shape();
  addThirteenthButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 13, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  addThirteenthButton.addEventListener("click", function(event) {
    if(addThirteenth){
      addThirteenthButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 13, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    } else {
      addThirteenthButton.graphics.beginFill("Pink").drawRoundRectComplex(KEYSIZE * 13, KEYSIZE, KEYSIZE, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
    }
  ...
  addThirteenthText.y = KEYSIZE * 1.3
