...
function chordCallback(chord){
  console.log(recordedChords[chord][0])
  //console.log(test)
...
function addToolBar(){
  ...
  for (var i = 0; i < 14; i++){
    ...
    var text =  new createjs.Text(chords[i], KEYSIZE/2 + "px Arial", "#000000")
    text.x = KEYSIZE/5
    text.y = KEYSIZE/3
  ...
  var text =  new createjs.Text("Fourth Octave", KEYSIZE/2 + "px Arial", "#000000")
  text.x = KEYSIZE * 2
  text.y = KEYSIZE * 3.3
  ...
  var defaultTriadText =  new createjs.Text("Triad", (KEYSIZE/2) + "px Arial", "#000000")
  ...
  var firstInversionText =  new createjs.Text("First Inversion", (KEYSIZE/2) + "px Arial", "#000000")
  ...
  var secondInversionText =  new createjs.Text("Second Inversion", (KEYSIZE/2) + "px Arial", "#000000")
  ...
  var exportText =  new createjs.Text("Export MIDI", (KEYSIZE/2) + "px Arial", "#000000")
  ...
  var deleteText =  new createjs.Text("X", (KEYSIZE/2) + "px Arial", "#000000")
  ...
  tutorialButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 11, 0, KEYSIZE * 3, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  tutorialButton.addEventListener("click", function(event) {
    window.open("http://google.com");
  });
  toolbar.addChild(tutorialButton)
  var tutorialText =  new createjs.Text("Tutorial", (KEYSIZE/2) + "px Arial", "#000000")
  tutorialText.x = KEYSIZE * 11.3
  tutorialText.y = KEYSIZE * 0.3
  toolbar.addChild(tutorialText)

  // Credits
  var creditsButton = new createjs.Shape();
  creditsButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 11, KEYSIZE, KEYSIZE * 3, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  creditsButton.addEventListener("click", function(event) {
    window.open("http://google.com");
  });
  toolbar.addChild(creditsButton)
  var creditsText =  new createjs.Text("Credits", (KEYSIZE/2) + "px Arial", "#000000")
  creditsText.x = KEYSIZE * 11.3
  creditsText.y = KEYSIZE * 1.3
  toolbar.addChild(creditsText)

  // Donate
  var donateButton = new createjs.Shape();
  donateButton.graphics.beginFill("White").drawRoundRectComplex(KEYSIZE * 11, KEYSIZE*2, KEYSIZE * 3, KEYSIZE, KEYROUND, KEYROUND, KEYROUND, KEYROUND);
  donateButton.addEventListener("click", function(event) {
    window.open("http://google.com");
  });
  toolbar.addChild(donateButton)
  var donateText =  new createjs.Text("Donate", (KEYSIZE/2) + "px Arial", "#000000")
  donateText.x = KEYSIZE * 11.3
  donateText.y = KEYSIZE * 2.3
